      ...
      try {
        ...
        return {
          ...
          diagnostics: () => startupOutput
            .split("\n")
            .filter((line) =>
              line.includes("Stella Praxis") || line.includes("Stella semantic routing failed") || line.includes("Stella turn preparation failed") || line.includes("Stella evidence assessment attempts:")
            )
            .slice(-20)
            .join("\n"),
          stop: async () => {
