...
const probes = [];
for (const flag of ["--guarded-active-memory", "--guarded-dreaming", "--guarded-provider", "--guarded-semantic", "--guarded-provider-stale", "--initialization", "--fragment-skill", "--correction", "--correction-recovery", "--correction-output-rejected", "--admission-replay", "--cancel", "--cancel-preparation", "--managed", "--advice-revision", "--outcome", "--question-recovery",
