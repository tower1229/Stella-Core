    ...
    try {
      result = await complete({
        ...
        systemPrompt: [
          ...
          "For praxis, when exactly one supplied open Episode is semantically relevant to the request, include its exact ref as openEpisodeRef; otherwise omit openEpisodeRef.",
