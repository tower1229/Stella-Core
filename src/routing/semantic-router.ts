...
export function createSemanticRouter(
  ...
  return async (prompt, candidates) => {
    ...
    const systemPrompt = [
      ...
      "When an existing Episode is selected, advice revises the same matter. Omit twinPrediction: its original prediction (including absence) is already sealed and cannot be replaced by this turn.",
