...
test("rejects dirty or incomplete candidate evidence", async () => {
  ...
  const base = {
    ...
    artifactPath,
    recovery: {
      schemaVersion: "stella.exact-host-recovery-receipt/v2" as const,
      sourceCloneVerified: true as const,
      nativeFinalsBound: true as const,
      transport: "chat.send" as const,
      runtimeEpisodeContract: "stella.praxis-episode/v2" as const,
      coreRevision: core.revision,
      canghaiRevision: canghai.revision,
    ...
    praxisLoop: {
      schemaVersion: "stella.exact-host-praxis-receipt/v2" as const,
      episodeSchemaVersion: "stella.praxis-episode/v2" as const, transport: "chat.send" as const,
      adviceRevisionPersisted: true as const, predictionStatus: "sealed" as const,
      coreRevision: core.revision,
      initialCanghaiRevision: "4".repeat(40),
      finalCanghaiRevision: canghai.revision,
      hostVersion: "2026.8.2" as const,
